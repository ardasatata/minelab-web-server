...
def check_player_img_postition(img):
    ...
    try:
        with time_limit(1):
            with mp_holistic_checker.Holistic(min_detection_confidence=0.3, min_tracking_confidence=0.3, model_complexity=0, smooth_landmarks=True, static_image_mode=True) as holistic:
